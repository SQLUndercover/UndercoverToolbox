...
--config variables
DECLARE @logpath NVARCHAR(260) = 'D:\SQLData'
DECLARE @datapath NVARCHAR(260) = 'E:\SQLLogs'
...
BEGIN
	SET @STMT = N'ALTER DATABASE ' + QUOTENAME(@DBName) + N' MODIFY FILE (NAME = ' + @logicalname + N', FILENAME = '''
	SET @STMT += CASE 
			WHEN @type = 0
